---
title: "package.json: scripts and versions"
description: "The fixed script vocabulary every repo uses, what is banned, and how versions are pinned once per repo."
---
